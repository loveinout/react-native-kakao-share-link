 ...
 * @property result   결과
 */
export declare type CallbackType = (error?: Error, result?: SendResultType) => void;
/**
 ...
 */
export declare const sendCommerce: (commerceTemplate: CommerceTemplateType, callback?: CallbackType | undefined) => Promise<SendResultType>;
/**
 * sendList
 ...
 * @returns {Promise<SendResultType>}
 */
export declare const sendList: (listTemplate: ListTemplateType, callback?: CallbackType | undefined) => Promise<SendResultType>;
/**
 * sendFeed
 ...
 * @returns {Promise<SendResultType>}
 */
export declare const sendFeed: (feedTemplate: FeedTemplateType, callback?: CallbackType | undefined) => Promise<SendResultType>;
/**
 * sendText
 ...
 * @returns {Promise<SendResultType>}
 */
export declare const sendText: (textTemplate: TextTemplateType, callback?: CallbackType | undefined) => Promise<SendResultType>;
/**
 * sendLocation
 ...
 * @returns {Promise<SendResultType>}
 */
export declare const sendLocation: (locationTemplate: LocationTemplateType, callback?: CallbackType | undefined) => Promise<SendResultType>;
/**
 * sendCustom
 ...
 * @returns {Promise<SendResultType>}
 */
export declare const sendCustom: (customTemplate: CustomTemplateType, callback?: CallbackType | undefined) => Promise<SendResultType>;
...
declare const _default: KakaoShareLinkType;
